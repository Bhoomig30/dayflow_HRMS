...
const suggestions = ["How many leave requests are pending?", "Give me an attendance summary.", "Which employees have attendance issues?", "Summarize recent HR activity."];
